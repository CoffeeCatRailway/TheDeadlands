...
public class DeadItems {
    ...
    //Tools
    public static final RegistryObject<AxeItem> DEAD_WOOD_AXE = REGISTER.register("dead_wood_axe", () -> new AxeItem(ItemTier.WOOD, 6f, -2.88f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<PickaxeItem> DEAD_WOOD_PICKAXE = REGISTER.register("dead_wood_pickaxe", () -> new PickaxeItem(ItemTier.WOOD, 1, -2.52f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<ShovelItem> DEAD_WOOD_SHOVEL = REGISTER.register("dead_wood_shovel", () -> new ShovelItem(ItemTier.WOOD, 1.5f, -2.7f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<SwordItem> DEAD_WOOD_SWORD = REGISTER.register("dead_wood_sword", () -> new SwordItem(ItemTier.WOOD, 3, -2.16f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<HoeItem> DEAD_WOOD_HOE = REGISTER.register("dead_wood_hoe", () -> new HoeItem(ItemTier.WOOD, 0, -2.7f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    ...
    public static final RegistryObject<AxeItem> COLDSTONE_AXE = REGISTER.register("coldstone_axe", () -> new AxeItem(ItemTier.STONE, 7f, -3.2f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<PickaxeItem> COLDSTONE_PICKAXE = REGISTER.register("coldstone_pickaxe", () -> new PickaxeItem(ItemTier.STONE, 1, -2.8f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<ShovelItem> COLDSTONE_SHOVEL = REGISTER.register("coldstone_shovel", () -> new ShovelItem(ItemTier.STONE, 1.5f, -3f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<SwordItem> COLDSTONE_SWORD = REGISTER.register("coldstone_sword", () -> new SwordItem(ItemTier.STONE, 3, -2.4f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<HoeItem> COLDSTONE_HOE = REGISTER.register("coldstone_hoe", () -> new HoeItem(ItemTier.STONE, -1, -2f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    ...
    public static final RegistryObject<SwordItem> HEAT_HAMMER = REGISTER.register("heat_hammer", () -> new SwordItem(ItemTier.DIAMOND, 3, -2.4f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
    public static final RegistryObject<PickaxeItem> HEAT_PICKAXE = REGISTER.register("heat_pickaxe", () -> new PickaxeItem(ItemTier.DIAMOND, 1, -2.8f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));

    public static final RegistryObject<SwordItem> MAIDENS_DAGGER = REGISTER.register("maidens_dagger", () -> new SwordItem(ItemTier.IRON, 3, -2.16f, new Item.Properties().group(TheDeadlands.GROUP_ALL).maxStackSize(1)));
